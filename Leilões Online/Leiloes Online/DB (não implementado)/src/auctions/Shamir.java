...
public final class Shamir
{
    ...
    public static void main(final String[] args)
    {
        ...
        final BigInteger secret = new BigInteger("123385389758937589734872970897329808937589375983745032785");
        ...
        sharesToViewSecret = new SecretShare[] {shares[3],shares[1]}; // 1 & 4
